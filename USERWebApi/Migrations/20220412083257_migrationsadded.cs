        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationModelId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctors", x => x.DoctorId);
                    table.ForeignKey(
                        name: "FK_Doctors_AspNetUsers_RegistrationModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_RegistrationModelId",
                table: "Doctors",
                column: "RegistrationModelId");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_RegistrationModelId",
                table: "Patients",
                column: "RegistrationModelId");
        }
